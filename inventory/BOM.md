...
| Rotary encoder with push button | 1 | Confirmed | `src/firmware/platform/rp2040/board/pico_wh.zig`, `src/firmware/platform/rp2040/drivers/rotary.zig` | SW on GPIO13, CLK on GPIO14, DT on GPIO15; all with internal pull-ups. Adjusts the target temperature (20–30 °C in 0.5 steps); button resets to 22.0 °C. |
